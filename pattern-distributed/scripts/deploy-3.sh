...
kubectl create secret docker-registry gcr-json-key --docker-server=https://gcr.io --docker-username=_json_key --docker-password="$(cat ../wso2-sp-distributed-179caa93fb3d.json)" --docker-email=madushi95lakshini@gmail.com
...
kubectl create -f ../sp/wso2sp-worker-1-service-1.yaml
kubectl create -f ../sp/wso2sp-worker-2-service-1.yaml
#kubectl create -f ../sp/wso2sp-worker-3-service.yaml
kubectl create -f ../sp/wso2sp-worker-4-service-1.yaml
