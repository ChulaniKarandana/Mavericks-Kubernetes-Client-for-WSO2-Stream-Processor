...
kubectl create secret docker-registry gcr-json-key --docker-server=https://gcr.io --docker-username=_json_key --docker-password="$(cat ../wso2-sp-distributed-baceca320c40.json)" --docker-email=madushi95lakshini@gmail.com
